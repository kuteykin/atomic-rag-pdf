...
# Launch Streamlit using the Poetry virtual environment
~/.cache/pypoetry/virtualenvs/atomic-rag-system--IQOUDR0-py3.10/bin/streamlit run streamlit_app.py --server.port 8501 --server.address localhost
